                ...
                child: Column(
                  ...
                  children: [
                    ..._existingAudios.map((file) {
                      ...
                      if (dotIndex != -1) {
                        String mainPart = cleanName.substring(0, dotIndex);
                      ...
                      // Fallback: standard pocketbase cleaning and URI decoding if not decoded yet
                      if (cleanName == file) {
                        ...
                        try {
                          cleanName = Uri.decodeFull(cleanName);
                        } catch (_) {}
                      }

...
module.exports = async (req, res) => {
  ...
  try {
      ...
      contents: [
        {
          parts: [
            ...
            {
              text: "قم بتلخيص هذا الملف الصوتي تلخيصاً وافياً ومفيداً باللغة العربية. قسّم التلخيص إلى الأفكار والنقاط الرئيسية الواردة في الصوت، واقرن كل فكرة بنقطتها الزمنية التقريبية الواردة بالملف بصيغة [MM:SS] (مثلاً: [01:23] - تقديم الفكرة الأولى). رتّب الأفكار والتلخيص في أسطر مرقمة واضحة ومختصرة لتكون مفيدة ومريحة للقراءة."
            }
          ]
        }
      ]
    ...
    const summary = await new Promise((resolveRequest, rejectRequest) => {

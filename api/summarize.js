      ...
      contents: [
        {
          parts: [
            ...
            {
              text: "قم بإنشاء فهرس ودليل زمني لمفاصل هذا الملف الصوتي باللغة العربية. لا تكتب أي مقدمات أو شرح أو نصوص طويلة. اكتب فقط أسطر مرتبة تمثل رؤوس الأقلام والأفكار الرئيسية للملَف، بحيث يبدأ كل سطر بالطابع الزمني الدقيق بصيغة MM:SS (مثال: 02:10 فكرة جديدة أو بداية موضوع جديد)، متبوعاً بعنوان الفكرة أو النقطة بشكل مختصر جداً ومفيد. تتبع بداية كل فكرة جديدة بدقة زمنية عالية."
            }
          ]
        }
      ]
